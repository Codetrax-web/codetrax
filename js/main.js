...
<section class="home-section">
    ...
    <div class="hero-section">
        <div class="hero-content">
            ...
            <p class="hero-description">
                Creamos soluciones digitales, sitios web, diseños y
                herramientas personalizadas para convertir ideas en
                proyectos reales.
            </p>
            <div class="hero-buttons">
                <a href="/contacto" class="hero-button primary" data-section="contacto">
                    🚀 Iniciar un proyecto
                </a>
                <a href="/settings" class="hero-button secondary" data-section="settings">
                    🧩 Ver nuestro trabajo
                </a>
            </div>
        </div>
        <div class="hero-visual">
            <div class="code-window">
                ...
                <div class="code-content">
                    <p><span class="code-purple">const</span> idea = <span class="code-blue">true</span>;</p>
                    <p><span class="code-purple">if</span> (idea) {</p>
                    <p class="code-indent">
                        <span class="code-purple">return</span>
                        <span class="code-green">"CODETRAX"</span>;
                    </p>
                    <p>}</p>
    ...
    <section class="services-preview">
        <div class="section-heading">
            ...
            <p>
                Combinamos tecnología, creatividad y estrategia
                para convertir ideas en experiencias reales.
            </p>
        </div>
        <div class="services-grid">
            <article class="service-card">
                ...
                <p>
                    Sitios web, plataformas y experiencias digitales
            ...
            <article class="service-card">
                ...
                <p>
                    Interfaces, identidad visual y recursos gráficos
            ...
            <article class="service-card">
                ...
                <p>
                    Herramientas y soluciones que ayudan a optimizar
            ...
            <article class="service-card">
                ...
                <p>
                    Analizamos tu idea y construimos una solución
    ...
    <section class="process-preview">
        ...
        <div class="process-grid">
            ...
            <div class="process-step">
                ...
                <h3>Creación</h3>
                <p>
                    Diseñamos y desarrollamos el proyecto.
                </p>
            </div>
            <div class="process-line"></div>
            <div class="process-step">
    ...
    <section class="home-cta">
        ...
        <p>
            ...
            Nosotros encontramos la forma de hacerlo posible.
        </p>
        <a href="/contacto" class="hero-button primary" data-section="contacto">
            🚀 Iniciar un proyecto
        </a>
